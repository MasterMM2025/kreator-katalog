...
container.innerHTML = "Brak produktów do wyświetlenia. Zaimportuj plik Excel.";
return;
}
...
rows = parsed.data;
// Elastyczne mapowanie nagłówków dla CSV, podobnie jak dla XLSX
if (rows.length > 0) {
