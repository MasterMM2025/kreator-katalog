...
                new Promise((*, rej) => setTimeout(() => rej(new Error('Timeout ładowania obrazu')), 5000))
              ]);
...
                new Promise((*, rej) => setTimeout(() => rej(new Error('Timeout ładowania loga')), 5000))
              ]);
              const logoW = 120;
              const logoH = 60;
...
      </div>
     : ''} &nbsp;&nbsp;&nbsp;&nbsp;<div class="edit-field"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Styl obramowania:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="editBorderStyle"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="solid" ${edit.borderStyle === 'solid' ? 'selected' : ''}>Pełna linia</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="dashed" ${edit.borderStyle === 'dashed' ? 'selected' : ''}>Kreskowana</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="dotted" ${edit.borderStyle === 'dotted' ? 'selected' : ''}>Kropkowana</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;<div class="edit-field"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Kolor obramowania:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="color" id="editBorderColor" value="${edit.borderColor || '#000000'}"> &nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;<div class="edit-field"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Tekstura tła:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="file" id="editBackgroundTexture" accept="image/*"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Przezroczystość:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="range" id="editBackgroundOpacity" min="0.1" max="1.0" step="0.1" value="${edit.backgroundOpacity || 1.0}"> &nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;<div class="edit-field"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Gradient tła strony:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="editPageBackgroundGradient"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="none" ${edit.pageBackgroundGradient === 'none' ? 'selected' : ''}>Brak</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="blue" ${edit.pageBackgroundGradient === 'blue' ? 'selected' : ''}>Niebieski</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="green" ${edit.pageBackgroundGradient === 'green' ? 'selected' : ''}>Zielony</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="gray" ${edit.pageBackgroundGradient === 'gray' ? 'selected' : ''}>Szary</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="red" ${edit.pageBackgroundGradient === 'red' ? 'selected' : ''}>Czerwony</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="purple" ${edit.pageBackgroundGradient === 'purple' ? 'selected' : ''}>Fioletowy</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="orange" ${edit.pageBackgroundGradient === 'orange' ? 'selected' : ''}>Pomarańczowy</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Przezroczystość tła:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="range" id="editPageBackgroundOpacity" min="0.1" max="1.0" step="0.1" value="${edit.pageBackgroundOpacity || 1.0}"> &nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;<button onclick="saveEdit(${productIndex})" class="btn-primary">Zapisz</button> &nbsp;&nbsp;;
...
  editForm.innerHTML = &nbsp;&nbsp;&nbsp;&nbsp;<div class="edit-field"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Wybierz stronę:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="editPageSelect"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${Array.from({ length: totalPages }, (_, i) =><option value="${i}" ${i === pageIndex ? 'selected' : ''}>Strona ${i + 1}</option>)} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;<div class="edit-field"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Czcionka nazwy:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="editNazwaFont"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Arial" ${edit.nazwaFont === 'Arial' ? 'selected' : ''}>Arial</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Helvetica" ${edit.nazwaFont === 'Helvetica' ? 'selected' : ''}>Helvetica</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Times" ${edit.nazwaFont === 'Times' ? 'selected' : ''}>Times New Roman</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="color" id="editNazwaColor" value="${edit.nazwaFontColor}"> &nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;<div class="edit-field"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Czcionka indeksu:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="editIndeksFont"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Arial" ${edit.indeksFont === 'Arial' ? 'selected' : ''}>Arial</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Helvetica" ${edit.indeksFont === 'Helvetica' ? 'selected' : ''}>Helvetica</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Times" ${edit.indeksFont === 'Times' ? 'selected' : ''}>Times New Roman</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="color" id="editIndeksColor" value="${edit.indeksFontColor}"> &nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;<div class="edit-field"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Czcionka rankingu:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="editRankingFont"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Arial" ${edit.rankingFont === 'Arial' ? 'selected' : ''}>Arial</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Helvetica" ${edit.rankingFont === 'Helvetica' ? 'selected' : ''}>Helvetica</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Times" ${edit.rankingFont === 'Times' ? 'selected' : ''}>Times New Roman</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="color" id="editRankingColor" value="${edit.rankingFontColor}"> &nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;<div class="edit-field"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Czcionka ceny:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="editCenaFont"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Arial" ${edit.cenaFont === 'Arial' ? 'selected' : ''}>Arial</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Helvetica" ${edit.cenaFont === 'Helvetica' ? 'selected' : ''}>Helvetica</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Times" ${edit.cenaFont === 'Times' ? 'selected' : ''}>Times New Roman</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="color" id="editCenaColor" value="${edit.cenaFontColor}"> &nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;<div class="edit-field"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Waluta:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="editCenaCurrency"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="EUR" ${edit.priceCurrency === 'EUR' ? 'selected' : ''}>€ (EUR)</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="GBP" ${edit.priceCurrency === 'GBP' ? 'selected' : ''}>£ (GBP)</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;<div class="edit-field"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Format ceny:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="priceFormat" value="true" ${edit.showPriceLabel ? 'checked' : ''}> Price: 1.45</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="priceFormat" value="false" ${!edit.showPriceLabel ? 'checked' : ''}> 1.45</label> &nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;<div class="edit-field"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Gradient tła strony:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="editPageBackgroundGradient"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="none" ${edit.pageBackgroundGradient === 'none' ? 'selected' : ''}>Brak</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="blue" ${edit.pageBackgroundGradient === 'blue' ? 'selected' : ''}>Niebieski</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="green" ${edit.pageBackgroundGradient === 'green' ? 'selected' : ''}>Zielony</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="gray" ${edit.pageBackgroundGradient === 'gray' ? 'selected' : ''}>Szary</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="red" ${edit.pageBackgroundGradient === 'red' ? 'selected' : ''}>Czerwony</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="purple" ${edit.pageBackgroundGradient === 'purple' ? 'selected' : ''}>Fioletowy</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="orange" ${edit.pageBackgroundGradient === 'orange' ? 'selected' : ''}>Pomarańczowy</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Przezroczystość tła:</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="range" id="editPageBackgroundOpacity" min="0.1" max="1.0" step="0.1" value="${edit.pageBackgroundOpacity || 1.0}"> &nbsp;&nbsp;&nbsp;&nbsp;</div> &nbsp;&nbsp;&nbsp;&nbsp;<button onclick="savePageEdit(${pageIndex})" class="btn-primary">Zapisz</button> &nbsp;&nbsp;;
  document.getElementById('editModal').style.display = 'block';
}
